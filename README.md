...
![Screenshot](assets/raycast_script_commands.png)
...
| `move-last-desktop-to-finder.sh` | Moves the most recently added Desktop file to the folder open in the frontmost Finder window. |
